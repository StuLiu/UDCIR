...
class UNet(nn.Module):
	...
	def __init__(self, input_c=3, output_c=3, N=32):
		...
		self.down_1 = nn.Conv2d(N * 4, N * 8, kernel_size=3, stride=2, padding=1)
		self.step_2 = Step(N=N * 8)
		self.down_2 = nn.Conv2d(N * 8, N * 16, kernel_size=3, stride=2, padding=1)
		...
		self.up_1 = nn.ConvTranspose2d(N * 16, N * 8, kernel_size=4, stride=2, padding=1)
		self.step_7 = Step(N=N * 8)
		self.up_2 = nn.ConvTranspose2d(N * 8, N * 4, kernel_size=4, stride=2, padding=1)

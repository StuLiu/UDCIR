...
class UNet(nn.Module):
	...
	def __init__(self, input_c=3, output_c=3, N=32):
		...
		self.U = nn.Sequential(
			...
			nn.LeakyReLU(0.2),
			# step_3
			nn.ConvTranspose2d(N * 16, N * 8, (4, 4), stride=2, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N * 8, N * 8, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N * 8, N * 8, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			# step_2
			nn.ConvTranspose2d(N * 8, N * 4, (4, 4), stride=2, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N * 4, N * 4, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N * 4, N * 4, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			# step_1
			nn.ConvTranspose2d(N * 4, N * 2, (4, 4), stride=2, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N * 2, N * 2, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N * 2, N * 2, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			# step_0
			nn.ConvTranspose2d(N * 2, N, (4, 4), stride=2, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N, N, (3, 3), stride=1, padding=1),
			nn.LeakyReLU(0.2),
			nn.Conv2d(N, N, (3, 3), stride=1, padding=1),
